...
# WIRING: (over M12 (8pin) factory made cable)
...
See REF [4.0] #| 6.4.1 Checking Current Communication Settings (aXU)
See REF [4.0] #| 6.4.2 Settings Fields
}
...
answ> 0R0,Dm=204D,Sm=0.1M,Ta=23.4C,Ua=53.7P,Pa=984.6H,Rc=0.00M,Tr=128.4C,Ra=0.0M,Sl=0.001262V,Sr=-0.463549V,Rt=1505.6R,Th=24.2C,Vh=0.0N
 ...
 The message structure is the same as with data query commands aR1, aR2,aR3 , and aR5. You can choose an individual update interval for each sensor.see point 6.4.3
...
See REF [4.0] #| 7.2.4 Wind Data Message (aR1)
See REF [4.0] #| 7.2.5 Pressure, Temperature and Humidity Data Message (aR2)
See REF [4.0] #| 7.2.6 Precipitation Data Message (aR3)
See REF [4.0] #| 7.2.7 Supervisor Data Message (aR5)
}


{# [5.0] Set Sensor Bus Address  
See REF [4.0] #| 6.4.3 Changing the Communication Settings (aXU)
}


{# [6.0] Setting the Sensor Period Output Report Interval 
See REF [4.0] #| 7.2.11 Automatic Mode
See REF [4.0] #| 6.4.2 Settings Fields -> [I] Automatic repeat interval for Composite data message 
# check Sensor User manual ...
}


{# [7.0] Defining Sesnor Output Format  
See REF [4.0] 8.1.1   Wind Sensor
See REF [4.0] 8.1.2 Pressure, Temperature, and Humidity Sensors
See REF [4.0] 8.1.3 Precipitation Sensor
See REF [4.0] 8.1.4 Supervisor Message
# check Sensor User manual ...
}
