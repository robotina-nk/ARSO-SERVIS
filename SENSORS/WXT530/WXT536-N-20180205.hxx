...
REF E.1 General Unit Settings{
	####| TEST: ###################################################################################################################
	cmd> echo -n -e "0XF\r\n"  | nc -w 2 172.19.6.84 64008
	answ> 0XF,f=11111111&11100110,o=6B4B2A2B2B1B,c=N164,i=Hel,n=N1641709,2=2499,3=3623,b=x,s=1
/**		LEGEND
			...
			n - Device s/n -       A,B,...=2005,2006..., 1..52 = week, 1 … 7 = weekday , 1 … 9999 = serial number
...
{# [9.0] PARAMETERS CUSTOMIZATION FOR COMPOSITE MESSAGE{
Composite Data Message Query (aR0) [REF 7.2.9]
echo -n -e "0R0\r\n" > /dev/ttyUSB_RS485_1
	0R0,Dm=000#,Sm=99.9#,Ta=23.3C,Ua=23.6P,Pa=987.8H,Rc=0.00M,Tr=250.2C,Ra=0.0M,Sl=0.001481V,Sr=-1.392049V,Rt=649.8R,Th=24.2C,Vh=0.0N
_____________________________________________________________________________________________________________________________________________________________________________
Wind Data Message (aR1) [REF 7.2.4]
echo -n -e "0R1\r\n" > /dev/ttyUSB_RS485_1
	0R1,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#
Checking the Settings (aWU) [REF 8.1.1.1 / 8.1.1.2]
echo -n -e "0WU\r\n" > /dev/ttyUSB_RS485_1
	0WU,R=11111100&01001000,I=5,A=3,G=1,U=M,D=0,N=W,F=4
Changing the Settings (aWU) [REF 8.1.1.3 / 8.1.1.2]
echo -n -e "0WU,R=1111110011111100\r\n" > /dev/ttyUSB_RS485_1
	0WU,R=11111100&11111100
Checking the Settings (aWU) [REF 8.1.1.1 / 8.1.1.2]
echo -n -e "0WU\r\n" > /dev/ttyUSB_RS485_1
	0WU,R=11111100&11111100,I=5,A=3,G=1,U=M,D=0,N=W,F=4	
Composite Data Message Query (aR0) [REF 7.2.9]
echo -n -e "0R0\r\n" > /dev/ttyUSB_RS485_1
	0R0,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#,Ta=23.3C,Ua=23.5P,Pa=987.6H,Rc=0.00M,Tr=531.7#,Ra=0.0M,Sl=0.001481V,Sr=-1.392049V,Rt=3085.4R,Th=24.2C,Vh=0.0N
        ================================================
_____________________________________________________________________________________________________________________________________________________________________________
Pressure, Temperature and Humidity Data Message (aR2) [REF 7.2.5]
echo -n -e "0R2\r\n" > /dev/ttyUSB_RS485_1
	0R2,Ta=23.4C,Ua=23.5P,Pa=987.5H
Checking the Settings (aTU) [REF 8.1.2.1 / 8.1.2.2]
echo -n -e "0TU\r\n" > /dev/ttyUSB_RS485_1
	0TU,R=11010000&11010000,I=1,P=H,T=C,N=T
Changing the Settings (aTU) [REF 8.1.2.3 / 8.1.2.2]
echo -n -e "0TU,R=1111000011110000\r\n" > /dev/ttyUSB_RS485_1
	0TU,R=11110000&11110000
Checking the Settings (aTU) [REF 8.1.2.1 / 8.1.2.2]
echo -n -e "0TU\r\n" > /dev/ttyUSB_RS485_1
	0TU,R=11110000&11110000,I=1,P=H,T=C,N=T
Composite Data Message Query (aR0) [REF 7.2.9]
echo -n -e "0R0\r\n" > /dev/ttyUSB_RS485_1
	0R0,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#,Ta=23.3C,Tp=23.6C,Ua=23.3P,Pa=987.3H,Rc=0.00M,Tr=-822.8#,Ra=0.0M,Sl=0.001481V,Sr=-1.392049V,Rt=-2222.2R,Th=24.2C,Vh=0.0N
                                                         ====================================
_____________________________________________________________________________________________________________________________________________________________________________
Precipitation Data Message (aR3) [REF 7.2.6]
echo -n -e "0R3\r\n" > /dev/ttyUSB_RS485_1
	0R3,Rc=0.00M,Rd=0s,Ri=0.0M,Hc=0.0M,Hd=0s,Hi=0.0M
Checking the Settings (aRU) [REF 8.1.3.1 / 8.1.3.2]
echo -n -e "0RU\r\n" > /dev/ttyUSB_RS485_1
	0RU,R=11111100&10000000,I=60,U=M,S=M,M=R,Z=M,X=10000,Y=100
Changing the Settings (aRU) [REF 8.1.3.3 / 8.1.3.2]
echo -n -e "0RU,R=1111111111111111\r\n" > /dev/ttyUSB_RS485_1
	0RU,R=11111111&11111111
Checking the Settings (aRU) [REF 8.1.3.1 / 8.1.3.2]
echo -n -e "0RU\r\n" > /dev/ttyUSB_RS485_1
	0RU,R=11111111&11111111,I=60,U=M,S=M,M=R,Z=M,X=10000,Y=100
Composite Data Message Query (aR0) [REF 7.2.9]
echo -n -e "0R0\r\n" > /dev/ttyUSB_RS485_1
	0R0,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#,Ta=23.4C,Tp=23.7C,Ua=23.3P,Pa=987.3H,Rc=0.00M,Rd=0s,Ri=0.0M,Hc=0.0M,Hd=0s,Hi=0.0M,Rp=0.0M,Hp=0.0M,Tr=495.2C,Ra=0.0M,Sl=0.001481V,Sr=-1.392049V,Rt=2665.0R,Th=24.2C,Vh=0.0N
                                                                                              ============================================================
_____________________________________________________________________________________________________________________________________________________________________________
Getting Data Messages (aR4) [REF 8.1.6.5]     NOT USED!!
echo -n -e "0R4\r\n" > /dev/ttyUSB_RS485_1
0R4,Tr=-13.7C,Ra=0.0M,Sl=0.001044V,Rt=946.0R,Sr=-1.392049V
    ========= ======= ============           =============
...
_____________________________________________________________________________________________________________________________________________________________________________
Supervisor Data Message (aR5) [REF 7.2.7]
echo -n -e "0R5\r\n" > /dev/ttyUSB_RS485_1
	0R5,Th=24.2C,Vh=0.0N,Vs=13.9V,Vr=3.665V
Checking the Settings (aSU) [REF 8.1.4.1 / 8.1.4.2]
echo -n -e "0SU\r\n" > /dev/ttyUSB_RS485_1
	0SU,R=11110000&11000000,I=15,S=Y,H=Y,a=0.400000000,b=4.000000000,c=0.000000000,d=20.000000000,e=24.000000000,f=0.044444400,g=4.000000000,h=0.000000000,j=20.000000000,k=24.000000000
Changing the Settings (aSU) [REF 8.1.4.3 / 8.1.4.2]
echo -n -e "0SU,R=1111100011111000\r\n" > /dev/ttyUSB_RS485_1
	0SU,R=11111000&11111000
Checking the Settings (aSU) [REF 8.1.4.1 / 8.1.4.2]
echo -n -e "0SU\r\n" > /dev/ttyUSB_RS485_1
	0SU,R=11111000&11111000,I=15,S=Y,H=Y,a=0.400000000,b=4.000000000,c=0.000000000,d=20.000000000,e=24.000000000,f=0.044444400,g=4.000000000,h=0.000000000,j=20.000000000,k=24.000000000
Composite Data Message Query (aR0) [REF 7.2.9]
echo -n -e "0R0\r\n" > /dev/ttyUSB_RS485_1
	0R0,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#,Ta=23.4C,Tp=23.6C,Ua=23.2P,Pa=987.2H,Rc=0.00M,Rd=0s,Ri=0.0M,Hc=0.0M,Hd=0s,Hi=0.0M,Rp=0.0M,Hp=0.0M,Tr=310.7C,Ra=0.0M,Sl=0.001372V,Sr=-1.392049V,Rt=2452.4R,Th=24.2C,Vh=0.0N,Vs=13.9V,Vr=3.680V,Id=Hel                                                                                                                                                                                                                        =========================================
                                                                                                                                                                                                                   ==========================================
_____________________________________________________________________________________________________________________________________________________________________________
...
debian:~# echo -n -e "0r1Goe\r\n" > /dev/ttyUSB_RS485_1
	0r1,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#Aj}
debian:~# echo -n -e "0r2Gje\r\n" > /dev/ttyUSB_RS485_1
	0r2,Ta=23.4C,Tp=23.6C,Ua=23.0P,Pa=987.2HCzz
debian:~# echo -n -e "0r3Kid\r\n" > /dev/ttyUSB_RS485_1
	0r3,Rc=0.00M,Rd=0s,Ri=0.0M,Hc=0.0M,Hd=0s,Hi=0.0M,Rp=0.0M,Hp=0.0MNW{
debian:~# echo -n -e "0r5Kcd\r\n" > /dev/ttyUSB_RS485_1
	0r5,Th=24.2C,Vh=0.0N,Vs=13.9V,Vr=3.664V,Id=HelB\W
debian:~# echo -n -e "0r0Kld\r\n" > /dev/ttyUSB_RS485_1
	0r0,Dn=000#,Dm=000#,Dx=000#,Sn=0.0#,Sm=99.9#,Sx=0.0#,Ta=23.3C,Tp=23.6C,Ua=23.0P,Pa=987.2H,Rc=0.00M,Rd=0s,Ri=0.0M,Hc=0.0M,Hd=0s,Hi=0.0M,Rp=0.0M,Hp=0.0M,Tr=91.0C,Ra=0.0M,Sl=0.001372V,Sr=-1.392049V,Rt=2104.8R,Th=24.2C,Vh=0.0N,Vs=13.9V,Vr=3.662V,Id=Hel@EU
