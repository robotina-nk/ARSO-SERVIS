...
{#  [I.]  frequently used commnads smp3
}
...
#
#
# P034 uart_smp3_config (bcer=DEFAULT)
#	Interface	RS485C
#	Protocol:	MB-RTU_RS485
#	addr:		0
#	baud_rate:	19200
...
{#  [4.0N] Sensor Initialization
	...
	{Cheching the correct syntax for sending hexadecimal values
		...
		root@Moxa:/var/sda/amws/smp3d# cat smp3d.log | grep DevicePoll | tail
...
{#  [4.1] Sensor Data Request: polling data from smp3

}
{#  [4.2] Sensor Data Request/Response: polling to/from smp3
